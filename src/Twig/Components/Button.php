...
final class Button
{
    ...
    public function getVariantClasses(): string
    {
        return match ($this->variant) {
            'primary' => 'bg-blue-50 p-2 mt-5 rounded hover:bg-gray-700 font-bold text-base tracking-wider	',
            'white' => 'border border-black p-1 mt-5 text-black rounded hover:bg-gray-100 font-bold text-base tracking-wider',
