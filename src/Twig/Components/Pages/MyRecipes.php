...
final class MyRecipes extends AbstractController
{
    ...
    public function getRecipes(): array
    {
        ...
        $recipeCollection = [];
        $recipes = $this->recipeRepository->search($search, (self::PER_PAGE * $this->page), myRecipes: true);
    ...
    {
        $search = $this->getForm()->getData() ?? [];
        $countRecipes = $this->recipeRepository->search($search, count: true, myRecipes: true);
